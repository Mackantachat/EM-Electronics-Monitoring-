<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="report_breaking_rules.aspx.vb" Inherits="EM.report_breaking_rules" %>
            ...
            <form action="/Home/%23" method="post">
                <div class="box-body">
                    <div class="form-group col-md-6">
                        <h4 style="color: #429cb6"><i class="fa fa-book"></i>การกระทำความผิด</h4>
                    </div>
