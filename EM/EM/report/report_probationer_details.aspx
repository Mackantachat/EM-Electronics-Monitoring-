<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="report_probationer_details.aspx.vb" Inherits="EM.report_probationer_details" %>
            ...
            <form action="/Home/%23" method="post">
                <div class="box-body">
                    <div class="form-group col-md-6">
                        <h4 style="color: #429cb6"><i class="fa fa-book"></i>รายละเอียดผู้ถูกคุมประพฤติ</h4>
                    </div>
