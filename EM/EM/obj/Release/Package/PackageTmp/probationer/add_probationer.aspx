                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control required" id="probationer_education" placeholder="การศึกษาสูงสุด" />
                                        </div>
                                        <div class="col-md-3">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            ...
                                            <input type="text" class="form-control required" id="probationer_address_number" placeholder="เลขที่" />
                                        </div>
                                        <div class="col-md-2">
                                            <h5><b>หมู่</b></h5>
                                    ...
                                    <div class="row address">
                                        <div class="col-md-4">
                                            ...
                                            <select class="form-control required" id="probationer_province" data-placeholder="จังหวัด">
                                                <option selected></option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <h5><b>อำเภอ/เขต</b><b class="text-red">*</b></h5>
                                            <select class="form-control required" id="probationer_district" data-placeholder="อำเภอ/เขต"></select>
                                        </div>
                                        <div class="col-md-4">
                                            <h5><b>ตำบล/แขวง</b><b class="text-red">*</b></h5>
                                            <select class="form-control required" id="probationer_subdistrict" data-placeholder="ตำบล/แขวง"></select>
                                        </div>
                                    </div>
                                    <div class="row mt-15">
                                        <div class="col-md-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <h5><b>เลขที่</b><b class="text-red">*</b></h5>
                                            <input type="text" class="form-control required" id="current_address_number" placeholder="เลขที่" />
                                        </div>
                                        <div class="col-md-2">
                                            <h5><b>หมู่</b></h5>
                                    ...
                                    <div class="row address">
                                        <div class="col-md-4">
                                            <h5><b>จังหวัด</b><b class="text-red">*</b></h5>
                                            <select class="form-control required" id="current_province" data-placeholder="จังหวัด">
                                                <option selected></option>
                                            </select>
                                        </div>
                                        <div class="col-md-4">
                                            <h5><b>อำเภอ/เขต</b><b class="text-red">*</b></h5>
                                            <select class="form-control required" id="current_district" data-placeholder="อำเภอ/เขต"></select>
                                        </div>
                                        <div class="col-md-4">
                                            <h5><b>ตำบล/แขวง</b><b class="text-red">*</b></h5>
                                            <select class="form-control required" id="current_subdistrict" data-placeholder="ตำบล/แขวง"></select>
                                        </div>
                                    </div>
                                    <div class="row mt-15">
                                        <div class="col-md-12">
                                ...
                                <div class="panel-body">
                                    <fieldset class="scheduler-border" id="reference1">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <h5><b>คำนำหน้า</b><b class="text-red">*</b></h5>
                                                <select class="form-control required title" id="reference1_title" name="reference_title" data-placeholder="คำนำหน้า">
                                                    <option selected></option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>ชื่อ</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference1_name" name="reference_name" placeholder="ชื่อ" />
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>นามสกุล</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference1_last_name" name="reference_last_name" placeholder="นามสกุล" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>เพศ</b><b class="text-red">*</b></h5>
                                                <select class="required form-control gender" id="reference1_gender" name="reference_gender">
                                                    <option value="1">หญิง</option>
                                                    <option value="2">ชาย</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <h5><b>อายุ</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference1_age" name="reference_age" placeholder="อายุ" maxlength="3" />
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>เลขประจำตัวประชาชน</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required cardid" id="reference1_cardid" name="reference_cardid" placeholder="เลขประจำตัวประชาชน" maxlength="13" />
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>เบอร์โทรศัพท์(มือถือ)</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference1_mobile" name="reference_mobile" placeholder="เบอร์โทรศัพท์(มือถือ)" />
                                            </div>
                                        </div>
                                        <div class="row mt-15">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <h5><b>เลขที่</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference1_address_number" name="reference_address_number" placeholder="เลขที่" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>หมู่</b></h5>
                                                <input type="text" class="form-control" id="reference1_moo" name="reference_moo" placeholder="หมู่" />
                                            </div>
                                            <div class="col-md-5">
                                                <h5><b>ถนน</b></h5>
                                                <input type="text" class="form-control" id="reference1_road" name="reference_road" placeholder="ถนน" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>ซอย</b></h5>
                                                <input type="text" class="form-control" id="reference1_lane" name="reference_lane" placeholder="ซอย" />
                                            </div>
                                        </div>
                                        <div class="row address">
                                            <div class="col-md-4">
                                                <h5><b>จังหวัด</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference1_province" name="reference_province" data-placeholder="จังหวัด">
                                                    <option selected></option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>อำเภอ/เขต</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference1_district" name="reference_district" data-placeholder="อำเภอ/เขต"></select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>ตำบล/แขวง</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference1_subdistrict" name="reference1_subdistrict" data-placeholder="ตำบล/แขวง"></select>
                                            </div>
                                        </div>
                                        <div class="row mt-15">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <h5><b>เลขที่</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference1_current_address_number" name="reference_current_address_number" placeholder="เลขที่" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>หมู่</b></h5>
                                                <input type="text" class="form-control" id="reference1_current_moo" name="reference_current_moo" placeholder="หมู่" />
                                            </div>
                                            <div class="col-md-5">
                                                <h5><b>ถนน</b></h5>
                                                <input type="text" class="form-control" id="reference1_current_road" name="reference_current_road" placeholder="ถนน" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>ซอย</b></h5>
                                                <input type="text" class="form-control" id="reference1_current_lane" name="reference1_current_lane" placeholder="ซอย" />
                                            </div>
                                        </div>
                                        <div class="row address">
                                            <div class="col-md-4">
                                                <h5><b>จังหวัด</b><b class="text-red">*</b></h5>
                                                <select class="form-control required hidden" id="reference1_current_province" name="reference_current_province" data-placeholder="จังหวัด">
                                                    <option selected></option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>อำเภอ/เขต</b><b class="text-red">*</b></h5>
                                                <select class="form-control required hidden" id="reference1_current_district" name="reference_current_district" data-placeholder="อำเภอ/เขต"></select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>ตำบล/แขวง</b><b class="text-red">*</b></h5>
                                                <select class="form-control required hidden" id="reference1_current_subdistrict" name="reference_current_subdistrict" data-placeholder="ตำบล/แขวง"></select>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <fieldset id="reference2" class="scheduler-border">
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <h5><b>คำนำหน้า</b><b class="text-red">*</b></h5>
                                                <select class="form-control required title" id="reference2_title" name="reference_title" data-placeholder="คำนำหน้า">
                                                    <option selected></option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>ชื่อ</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference2_name" name="reference_name" placeholder="ชื่อ" />
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>นามสกุล</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference2_last_name" name="reference_last_name" placeholder="นามสกุล" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>เพศ</b><b class="text-red">*</b></h5>
                                                <select class="required form-control gender" id="reference2_gender" name="reference_gender">
                                                    <option value="1">หญิง</option>
                                                    <option value="2">ชาย</option>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-2">
                                                <h5><b>อายุ</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference2_age" name="reference_age" placeholder="อายุ" maxlength="3" />
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>เลขประจำตัวประชาชน</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required cardid" id="reference2_cardid" name="reference_cardid" placeholder="เลขประจำตัวประชาชน" maxlength="13" />
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>เบอร์โทรศัพท์(มือถือ)</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference2_mobile" name="reference_mobile" placeholder="เบอร์โทรศัพท์(มือถือ)" />
                                            </div>
                                        </div>
                                        <div class="row mt-15">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <h5><b>เลขที่</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference2_address_number" name="reference_address_number" placeholder="เลขที่" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>หมู่</b></h5>
                                                <input type="text" class="form-control" id="reference2_moo" name="reference_moo" placeholder="หมู่" />
                                            </div>
                                            <div class="col-md-5">
                                                <h5><b>ถนน</b></h5>
                                                <input type="text" class="form-control" id="reference2_road" name="reference_road" placeholder="ถนน" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>ซอย</b></h5>
                                                <input type="text" class="form-control" id="reference2_lane" name="reference_lane" placeholder="ซอย" />
                                            </div>
                                        </div>
                                        <div class="row address">
                                            <div class="col-md-4">
                                                <h5><b>จังหวัด</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference2_province" name="reference_province" data-placeholder="จังหวัด">
                                                    <option selected></option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>อำเภอ/เขต</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference2_district" name="reference_district" data-placeholder="อำเภอ/เขต"></select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>ตำบล/แขวง</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference2_subdistrict" name="reference1_subdistrict" data-placeholder="ตำบล/แขวง"></select>
                                            </div>
                                        </div>
                                        <div class="row mt-15">
                                            <div class="col-md-12">
                                        ...
                                        <div class="row">
                                            <div class="col-md-3">
                                                <h5><b>เลขที่</b><b class="text-red">*</b></h5>
                                                <input type="text" class="form-control required" id="reference2_current_address_number" name="reference_current_address_number" placeholder="เลขที่" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>หมู่</b></h5>
                                                <input type="text" class="form-control" id="reference2_current_moo" name="reference_current_moo" placeholder="หมู่" />
                                            </div>
                                            <div class="col-md-5">
                                                <h5><b>ถนน</b></h5>
                                                <input type="text" class="form-control" id="reference2_current_road" name="reference_current_road" placeholder="ถนน" />
                                            </div>
                                            <div class="col-md-2">
                                                <h5><b>ซอย</b></h5>
                                                <input type="text" class="form-control" id="reference2_current_lane" name="reference1_current_lane" placeholder="ซอย" />
                                            </div>
                                        </div>
                                        <div class="row address">
                                            <div class="col-md-4">
                                                <h5><b>จังหวัด</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference2_current_province" name="reference_current_province" data-placeholder="จังหวัด">
                                                    <option selected></option>
                                                </select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>อำเภอ/เขต</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference2_current_district" name="reference_current_district" data-placeholder="อำเภอ/เขต"></select>
                                            </div>
                                            <div class="col-md-4">
                                                <h5><b>ตำบล/แขวง</b><b class="text-red">*</b></h5>
                                                <select class="form-control required" id="reference2_current_subdistrict" name="reference_current_subdistrict" data-placeholder="ตำบล/แขวง"></select>
                                            </div>
                                        </div>
                                    </fieldset>
                                    <%--End panel-body--%>
                                ...
                                <div class="panel-body">
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <input id="probationer_judge_name" type="text" class="required form-control" placeholder="ชื่อผู้สั่งใช้" />
                                        </div>
                                        <div class="col-md-4">
                                            <h5><b>นามสกุลผู้สั่งใช้</b></h5>
                                            <input id="probationer_judge_lastname" type="text" class="form-control" placeholder="นามสกุลผู้สั่งใช้" />
                                        </div>
                                        <div class="col-md-4">
                                            <h5><b>หมายเลขโทรศัพท์ผู้สั่งใช้</b></h5>
                                            <input id="probationer_judge_mobile" type="text" class="form-control" placeholder="หมายเลขโทรศัพท์ผู้สั่งใช้" />
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-4">
                                ...
                                <div class="panel-body">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="checkbox">
                                                <label class="custom">
                                                    <input id="probationer_activate_homebase" type="checkbox">
