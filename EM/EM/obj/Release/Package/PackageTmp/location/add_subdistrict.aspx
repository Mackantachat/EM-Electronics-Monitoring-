                ...
                <div class="datacontent">
                    ...
                    <div class="row address">
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control" id="txt_province" placeholder="จังหวัด" />
                            <select class="required hidden" id="province" data-placeholder="จังหวัด">
                                <option selected></option>
                            </select>
                        </div>
                        <div class="col-md-6">
                            <h5><b>อำเภอ<b class="text-red">*</b></b></h5>
                            <input type="text" class="form-control" id="txt_data_key" placeholder="อำเภอ" />
                            <select class="required hidden" id="data_key" data-placeholder="อำเภอ">
                                <option selected></option>
                            </select>
                        </div>
                    </div>
