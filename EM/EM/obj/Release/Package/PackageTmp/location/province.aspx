<%@ Page Title="" Language="vb" AutoEventWireup="false" MasterPageFile="~/MasterPage.Master" CodeBehind="province.aspx.vb" Inherits="EM.DTBprovince" %>
    ...
    <div class="col-md-12">
        <div class="box">
            <div class="row text-header">
                <div class="col-md-7">
                    <h3 class="text-blue">ข้อมูลจังหวัด</h3>
                </div>
                <div class="col-md-5">
                    <div class="col-md-6">
                    ...
                    <div class="col-md-6">
                        <a href="/location/add_province" class="btn btn-block btn-primary btntop">
                            <i class="fas fa-plus"></i>เพิ่มข้อมูลจังหวัด
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="row text-content">
                <div class="col-md-12 box-body table-responsive">
                    <table id="info_province" class="table table-striped">
                        <thead>
                            <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="JsContent" runat="server">
    ...
    <script>
        $(function () {
            $("#info_province").DataTable({
                aaSorting: [],
                ajax: {
                    url: "../control/location.aspx",
                    data: {
                        action: "list_province",
                    },
                    beforeSend: function () {
            ...
            control_datatable("#info_province", "6");
            $("#info_province").on("click", "a.update", function () {
            ...
            function update_status(data, list) {
                alertify.confirm("ยืนยันการเปลี่ยนสถานะจังหวัด", "คุณต้องการที่จะเปลี่ยนสถานะจังหวัดนี้หรือไม่? กด ok เพื่อลบ").set("onok", function () {
                    $.ajax({
                        url: "../control/location.aspx",
                        data: {
                            action: "status_province",
                            data: data,
                            list: list,
                        },
                        beforeSend: function () {
                        ...
                        success: function (data) {
                            if (!data.onError) {
                                ...
                                alertify.alert("ไม่สามารถเปลี่ยนสถานะจังหวัดได้");
                            }
                            $.busyLoadFull("hide");
                        }
                    });
